...
% load('Para_0823035917_pop_2400_gen_11218')
% load('Para_0825205059_pop_2400_gen_11524')
% load('Para_0827011713_pop_2400_gen_5955')
% load('Para_0828033844_pop_2400_gen_5483')
% load('Para_0829161214_pop_1000_gen_7243')
% load('Para_0904172146_pop_2400_gen_10711')
load('Para_0910155155_pop_1000_gen_22037')
index = 1;
...
% odeEvent = @(t,q)Events_thWaistLimited_AtHorizon(t,q,Para.constants);
absTol = Para.absTol;
% absTol = 1e-8;
...
figure(11)
clf('reset')
plot(time, [MthHand, MthHand_PassiveTorque])
legend('手の関節トルク', '手の受動的関節トルク')
grid on

figure(12)
clf('reset')
plot(time, [MthShoulder, MthShoulder_PassiveTorque])
legend('肩の関節トルク', '肩の受動的関節トルク')
grid on

figure(13)
clf('reset')
plot(time, [MthWaist, MthWaist_PassiveTorque])
legend('腰の関節トルク', '腰の受動的関節トルク')
grid on
