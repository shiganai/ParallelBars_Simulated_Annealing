...
ddrPB_tmp_After = find_ddrPB(InertiaLeg,InertiaArm,InertiaBody,MrPB_tmp,MthHand_tmp,MthWaist_tmp,MthShoulder_tmp,dthHand,dthWaist,dthShoulder,g,kPB_tmp,mArm,mBody,mLeg,mPB,rArm,rArmMCD,rBody,rBodyMCD,rLegMCD,rPB,thHand,thShoulder,thWaist);
Rest_Contri_ddrPB_Mth = (ddrPB_tmp_After - ddrPB_tmp_Before);
...
dmomentumG_tmp_After = find_dmomentumG(InertiaLeg,InertiaArm,InertiaBody,ddthHand_tmp,ddthWaist_tmp,ddthShoulder_tmp,ddxHand_tmp,ddyHand_tmp,dthHand,dthWaist,dthShoulder,mArm,mBody,mLeg,rArm,rArmMCD,rBody,rBodyMCD,rLegMCD,thHand,thShoulder,thWaist,xHand,yHand);
Rest_Contri_dmomentumG_ddth = (dmomentumG_tmp_After - dmomentumG_tmp_Before);
...
ddrPB_tmp_After = find_ddrPB_only(MrPB_tmp,ddthHand_tmp,ddthWaist_tmp,ddthShoulder_tmp,dthHand,dthWaist,dthShoulder,g,kPB_tmp,mArm,mBody,mLeg,mPB,rArm,rArmMCD,rBody,rBodyMCD,rLegMCD,rPB,thHand,thShoulder,thWaist);
Rest_Contri_ddrPB_ddth = (ddrPB_tmp_After - ddrPB_tmp_Before);
...
title('関節トルクの重心周りの角運動量への貢献係数')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献係数')
legend({'手', '肩', '腰', '平行棒の弾性'},'location','northeastoutside')
ax = gca;
ax.YLimMode = 'manual';
...
title('関節トルクの重心周りの角運動量への貢献量')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量(Nm)')
legend({'手', '肩', '腰', '平行棒の弾性', '残り'},'location','northeastoutside')
ax = gca;
ax.YLimMode = 'manual';
line([time_AtBodyUpStraight, time_AtBodyUpStraight], ax.YLim, 'LineStyle', ':', 'Color', 'black', 'DisplayName', '胴体が垂直')
ax.YGrid = 'on';
...
plot(time_onbar, [MthHand_Contri_dmomentumG_Integral, MthShoulder_Contri_dmomentumG_Integral, MthWaist_Contri_dmomentumG_Integral, kPB_Contri_dmomentumG_Mth_Integral])
title('関節トルクの重心周りの角運動量への貢献量の積分値')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量の積分値(Nms)')
legend({'手', '肩', '腰', '平行棒の弾性'},'location','northeastoutside')
...
plot(time_onbar, [MthHand_Coeffs_ddrPB, MthShoulder_Coeffs_ddrPB, MthWaist_Coeffs_ddrPB])
title('関節トルクのdrPBへの貢献係数')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献係数(N^{-1}s^{-2})')
legend({'手', '肩', '腰', '平行棒の弾性', '残り'},'location','northeastoutside')
...
% plot(time_onbar, [MthHand_Contri_ddrPB, MthShoulder_Contri_ddrPB, MthWaist_Contri_ddrPB, kPB_Contri_ddrPB, Rest_Contri_ddrPB])
title('関節トルクのdrPBへの貢献量')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量(ms^{-2})')
legend({'手', '肩', '腰', '平行棒の弾性', '残り'},'location','northeastoutside')
...
plot(time_onbar, [MthHand_Contri_ddrPB_Integral, MthShoulder_Contri_ddrPB_Integral, MthWaist_Contri_ddrPB_Integral])
title('関節トルクのdrPBへの貢献量の積分値')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量(ms^{-1})')
legend({'手', '肩', '腰', '平行棒の弾性', '残り'},'location','northeastoutside')
...
plot(time_onbar, [ddthHand_Contri_dmomentumG_Integral, ddthShoulder_Contri_dmomentumG_Integral, ddthWaist_Contri_dmomentumG_Integral, kPB_Contri_dmomentumG_ddth_Integral])
title('角加速度の重心周りの角運動量への貢献量の積分値')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量の積分値(Nms)')
legend({'手', '肩', '腰', '平行棒の弾性'},'location','northeastoutside')
...
plot(time_onbar, [ddthHand_Coeffs_ddrPB, ddthShoulder_Coeffs_ddrPB, ddthWaist_Coeffs_ddrPB])
title('角加速度のdrPBへの貢献係数')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量')
legend({'手の角加速度', '肩の角加速度', '腰の角加速度'},'location','northeastoutside')
ax = gca;
ax.YLimMode = 'manual';
line([time_AtBodyUpStraight, time_AtBodyUpStraight], ax.YLim, 'LineStyle', ':', 'Color', 'black', 'DisplayName', '胴体が垂直')
ax.YGrid = 'on';
...
title('角加速度のdrPBへの貢献量')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量(ms^{-2})')
legend({'手の角加速度', '肩の角加速度', '腰の角加速度', '平行棒の弾性', '残り'},'location','northeastoutside')
ax = gca;
ax.YLimMode = 'manual';
line([time_AtBodyUpStraight, time_AtBodyUpStraight], ax.YLim, 'LineStyle', ':', 'Color', 'black', 'DisplayName', '胴体が垂直')
ax.YGrid = 'on';
...
plot(time_onbar, [ddthHand_Contri_ddrPB_Integral, ddthShoulder_Contri_ddrPB_Integral, ddthWaist_Contri_ddrPB_Integral])
title('角加速度のdrPBへの貢献量の積分値')
xlabel('時間(s)')
xlim(time_onbar([1,end]))
ylabel('貢献量(ms^{-1})')
legend({'手の角加速度', '肩の角加速度', '腰の角加速度'},'location','northeastoutside')
