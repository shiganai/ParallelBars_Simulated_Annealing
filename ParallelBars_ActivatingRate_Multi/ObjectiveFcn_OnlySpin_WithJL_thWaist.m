function ObjectiveValueData = ObjectiveFcn_OnlySpin_WithJL_thWaist(time, q, constants, Spin_num_Goal, breakNum, ActivatingRate_index, Data_Set_Time, thWaist_AtBodyUpStraight_Range)
