...
% thDataArray = FyPB;
thDataArray = [ddt0_MthHandActivatedRate(:), ddt0_MthShoulderActivatedRate(:), ddt0_MthWaistActivatedRate(:)];
...
legend(graphs_main.axThData,{'ddt0\_手首の動員率', 'ddt0\_肩の動員率', 'ddt0\_腰の動員率'},'location','best')
