...
% Para_0714225020_pop_2400_gen_1977 index = 2289
load('Para_0715095857_pop_2400_gen_508')
index = 3;
...
% ActivatingRate_ii(9,3) = 0.25;
% ActivatingRate_ii(12:13,1) = -0.75;
...
figure(5)
plot(time, [thHand, thShoulder, thWaist])
legend({'手首の角度', '肩の角度', '腰の角度'})
xlabel('時間 [s]')
ylabel('角度 [°]')
