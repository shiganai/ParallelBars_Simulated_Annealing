...
ActivatingRate_Index = [reshape(ActivatingRate(index,1,:), [size(Data_Set_Time,1), 1]), reshape(ActivatingRate(index,2,:), [size(Data_Set_Time,1), 1]), reshape(ActivatingRate(index,3,:), [size(Data_Set_Time,1), 1])];
...
Para.ActivatingRate(index, 1, :) = ActivatingRate_Index(:, 1);
Para.ActivatingRate(index, 2, :) = ActivatingRate_Index(:, 2);
Para.ActivatingRate(index, 3, :) = ActivatingRate_Index(:, 3);
