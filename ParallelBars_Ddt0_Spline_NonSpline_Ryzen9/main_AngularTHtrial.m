...
if breakNum == 1
    ...
    time_until_landing = vG(end,2)/g + (2*height/g)^0.5; %vG(end,2)Ç™É}ÉCÉiÉXÇæÇ¡ÇΩèÍçáÇ≈Ç‡ëÂè‰ïv
...
legend({'éËéÒÇÃìÆàıó¶', 'å®ÇÃìÆàıó¶', 'çòÇÃìÆàıó¶'})
...
legend({'ddt0\_éËéÒÇÃìÆàıó¶', 'ddt0\_å®ÇÃìÆàıó¶', 'ddt0\_çòÇÃìÆàıó¶'})

figure(3)
plot(time, [dthHand, dthShoulder, dthWaist])
legend({'éËéÒÇÃäpë¨ìx', 'å®ÇÃäpë¨ìx', 'çòÇÃäpë¨ìx'})
