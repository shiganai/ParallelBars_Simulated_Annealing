...
Para.Data_Set_Time = (0:10e-2:1.4)';
Para.Joint_num = 3;
Para.ActivatingRate_Step_num = 4; % 1/30刻みで活性率を決める
...
% 評価値に関して
Para.Spin_num_Goal = 1.2;

% 初期値の設定
Para = generate_init_ActivatingRate(Para);
% Para = load_and_fit_init_Mdatas(Para, 'Para_0709221323_pop_2400_gen_4356', 2400);
