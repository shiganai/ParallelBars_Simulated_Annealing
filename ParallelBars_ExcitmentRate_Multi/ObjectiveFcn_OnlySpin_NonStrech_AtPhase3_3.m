function ObjectiveValueData = ObjectiveFcn_OnlySpin_NonStrech_AtPhase3_3(time, q, constants, Spin_num_Goal, breakNum, ActivatingRate_index, Data_Set_Time)
