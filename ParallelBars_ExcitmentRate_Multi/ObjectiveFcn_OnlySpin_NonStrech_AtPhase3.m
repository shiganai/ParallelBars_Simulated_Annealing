function ObjectiveValueData = ObjectiveFcn_OnlySpin_NonStrech_AtPhase3(time, q, constants, Spin_num_Goal, breakNum, ActivatingRate_index, Data_Set_Time)
...
ObjectiveValueData = [ObjectiveValue, spinValue, Target_Indexes_AR_Values(1,1), Target_Indexes_AR_Values(2,1), Target_Indexes_AR_Values(3,1), Target_Indexes_AR_Values(4,1), Target_Indexes_AR_Values(5,1)];
