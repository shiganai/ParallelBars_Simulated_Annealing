...
DataNames = ...
    {
    'Para_0723091221_pop_1000_gen_4759';
...
%     end
    ...
    scatter(Spin_num, ObjectiveValueDatas(:,1), RowDataSize, '+', 'DisplayName', LegendName, 'MarkerEdgeColor', line_tmp.CData)
    xlabel('’…’n‚Ü‚Å‚Ì‰ñ“]”')
    ylabel('‘S‘Ì‚Ì•]‰¿’l')
    legend
    drawnow
    ...
    scatter(Spin_num, ObjectiveValueDatas(:,2), RowDataSize, '+', 'DisplayName', LegendName, 'MarkerEdgeColor', line_tmp.CData)
    xlabel('’…’n‚Ü‚Å‚Ì‰ñ“]”')
    ylabel('‰ñ“]”‚ÉŠÖ‚·‚é•]‰¿’l')
    legend
    drawnow
    ...
    scatter(Spin_num, ObjectiveValueDatas(:,3), RowDataSize, '+', 'DisplayName', LegendName, 'MarkerEdgeColor', line_tmp.CData)
    xlabel('’…’n‚Ü‚Å‚Ì‰ñ“]”')
    ylabel('“®ˆõ—¦•Ï‰»‚ÉŠÖ‚·‚é•]‰¿’l')
    legend
    drawnow
    ...
    scatter(Spin_num, ObjectiveValueDatas(:,4), RowDataSize, '+', 'DisplayName', LegendName, 'MarkerEdgeColor', line_tmp.CData)
    xlabel('’…’n‚Ü‚Å‚Ì‰ñ“]”')
    ylabel('Á”ïƒGƒlƒ‹ƒM[‚ÉŠÖ‚·‚é•]‰¿’l')
    legend
    drawnow
